---
title: "Draft / Preliminary Proposal — Logic Package Architecture from the UA–FOL Spine"
status: "preliminary sketch"
purpose: "Repo reference for a possible package architecture, not a finalized implementation contract."
---
